...
public class WebSecurityConfig {
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http, AuthenticationManager auth){
        return http
                .csrf().disable()
                .authorizeExchange()
                ...
                .and()
                .addFilterAt(bearerAuthenticationFilter(auth), SecurityWebFiltersOrder.AUTHENTICATION)
                .build();
    }
